"""
Django settings for brew_and_bloom project.
...
INSTALLED_APPS = [
    ...
    'brew_and_bloom',  # Change to match your app name
    'products',
    'bag',
]
...
# Email setup for Gmail or your coffee shop domain
if 'DEVELOPMENT' in os.environ:
    EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'
    DEFAULT_FROM_EMAIL = 'brew_and_bloom@example.com'  # Update email address
else:
